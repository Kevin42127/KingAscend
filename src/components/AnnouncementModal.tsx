  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-300 p-4">
      <div className="bg-white rounded-lg p-6 sm:p-8 max-w-md w-full mx-2 sm:mx-4 transition-transform duration-300">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-3 sm:mb-4 text-amber-900">{t('noticeTitle')}</h2>
        <p className="text-center text-base sm:text-lg text-amber-700 mb-4 sm:mb-6 whitespace-pre-line">
          {t('noticeBody')}
        </p>
        <button
          onClick={onClose}
